...
@Service
public class useCaseTransaccionDepositoImp implements useCaseTransaccionDeposito
{
    @Autowired
    ...
    {
        eventBus.publishMessageLog("[UseCase Transaccion Deposito " + tipo.toString() + "] Creando nueva transaccion");
        ...
        return cuenta_repositorio.findById(idCuenta)
                .flatMap(cuenta -> {
                    ...
                    return transaccion_repositorio.save(transaccion)
                            ...
                            .doOnSuccess(tr -> {
                                                eventBus.publishMessageLog("[UseCase Transaccion Deposito " + tipo.toString() + "] Transacción guardada y cuenta actualizada exitosamente");
                                               })
